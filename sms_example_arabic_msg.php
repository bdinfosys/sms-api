...
$bdinfosys_sms->charset=	6;																					// Charset required for Arabic text.
$bdinfosys_sms->msgtext=	"063506280627062D002006270644062E064A0631";	// SMS Message text 'Good Morning' in Arabic.
...
$bdinfosys_sms->phone=	'recipient';																	// The full International mobile number of the
																				// recipient excluding the leading (+) e.g. 96XXXXXXXX
