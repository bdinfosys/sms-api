...
class sms{
	...
	/**
   	...
   	* String
   	*/
	public $provider=	'rsms.bdinfosys.com';
	...
	/**
   	...
   	* String
   	*/
	public $balance_url=	'http://rsms.bdinfosys.com/bulksms/getBALANCE.go';	
	...
	/**
   	...
   	* String
   	*/
	public $send_url=	'http://rsms.bdinfosys.com/bulksms/bulksend.go'; 			
